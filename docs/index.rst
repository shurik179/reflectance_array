...
This document describes the reflectanse array sensor. It is intended for use 
with small robots for tasks such as line following, sumo robots, and more.  It was
created by `shurik179 <https://github.com/shurik179>`__. All software and hardware 
...
* contains an MCU (attiny 1616) which takes care of reading individual sensor input, 
applying calibrations, and computing line position for line following tasks
